...
const getBooks = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't get books" }).code(500);
  }
};
...
const create = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't add book" }).code(500);
  }
};
...
const findById = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't find book" }).code(500);
  }
};
