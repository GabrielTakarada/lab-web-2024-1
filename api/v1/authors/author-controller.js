...
const getAuthors = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't get any authors" }).code(500);
  }
};
...
const create = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't add authors" }).code(500);
  }
};
...
const findById = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't search authors" }).code(500);
  }
};
...
const deleteById = async (request, h) => {
  ...
  try {
    ...
    console.error(error);
    return h.response({ error: "It can't remove authors" }).code(500);
  }
};
